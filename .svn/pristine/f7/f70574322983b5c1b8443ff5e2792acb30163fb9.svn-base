...
<body>
    <div class="main">
        <div class="mtop">
            ...
            <button class="btn btn-success"  type="button" style="margin: 0px; " onClick="location.href = 'common_notification_page';">Notifications <span class="badge"><?php print_r($num); ?></span></button>
