  ...
  <div class="mtop">
   ...
   <div class="mbar">
  		<!--Nav Bar Start -->
        	...
        	<button class="btn btn-success"  type="button" onClick="location.href = 'employeePool';">Employee Pool </button>
    ...
    <div class=" panel panel-success" style="width:1100px; float:left; position:relative; min-height:450px;">
    	<div class="panel-heading ">
      		<h3 class="panel-title" align="center">Employee Pool</h3>
     	</div>
        <!--div class="panel-body" style="height:15px; width:100%;"></div-->
      <div class="panel-body">
      
      <!-- pool Start-->
      <?php require_once('poolsearch.php'); ?>
